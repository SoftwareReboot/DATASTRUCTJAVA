package Compilation.InfixToPostFix;

import java.util.Scanner;

import Compilation.List.StackList;
...
public class infixtopostfix {
   ...
   public static void exeMenuInfixToPostfix(Scanner scann) {
      String choice;
        ...
        do {
            ...
            switch (choice) {
                ...
                case "2":
                    ...
                    String postfixInput = scann.nextLine();
